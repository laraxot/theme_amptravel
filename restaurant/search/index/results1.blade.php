              ...
              <div class="col-12 sm-col-6 lg-col-4 p1 travel-results-result">
                <div class="relative travel-results-result">
                  <a class="travel-results-result-link" href="#">
                    <amp-img class="rounded bg-silver mb1" width="2" height="1" noloading="" layout="responsive" src="/img/travel/activity/{{img}}.jpg" srcset="/img/travel/activity/{{img}}@2x.jpg 2x, /img/travel/activity/{{img}}.jpg 1x"></amp-img>
                  </a>
                  {{#flags.new}}
